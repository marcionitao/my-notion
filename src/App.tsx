...
export default function App() {
  return (
    <div
      className={` min-h-screen p-8 text-zinc-900 bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100`}
    >
      <div
        className={`bg-white w-[1100px] mx-auto rounded-xl min-h-[600px] shadow-sm border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]`}
      >
